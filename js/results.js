...
$(function(){
	...
	$(document).on('click','.next-passenger .right button',function(){
		...
		if(firstName==0 && lastName==0 && documentNumber==0 && age==0 && animals==0 && equipment==0 && documentType==0 && addBaggage==0 && citizentship==0){
			$('.next-passenger .left'+x).html("<img src='images/done.png' height='40px' width='40px'><span style='color: #97c16a'>Done</span>");
			check[x]="done";
	...
	$(document).on('click','#change1',function(){
		...
		$('.step2').removeClass('show');
		$('.panel-menu1').addClass('show');
		$('.panel-menu4').removeClass('show');
		$('.panel-menu2').removeClass('show');
	})
